...
The getting-started chapters left you with a small but complete bot. The core-concepts chapters are where fluxcord opens up: each one takes a single feature of the framework, explains how it works, and folds it into the example bot. Read them in order; every chapter builds on the ones before it.
